...
# 業界種別情報を初期設定
Industry_type.create(name: "メーカー")
Industry_type.create(name: "商社・卸売")
Industry_type.create(name: "建設工事")
Industry_type.create(name: "小売・流通")
Industry_type.create(name: "不動産関連")
Industry_type.create(name: "運輸・物流")
